    ...
    scan()
    {
        ...
        if( this.karigar_detail.status !='Verified'){
            let alert = this.alertCtrl.create({
                ...
                subTitle:"Your current profile status is not  <strong>“Verified”</strong>. You only scan the coupon codes when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42015577>011-42015577</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
  ...
  goOnContact(){
    ...
    alert1(){
        let alert = this.alertCtrl.create({
            ...
            subTitle:"Your current profile status is not <strong class=Approved>“Verified”</strong>.To know more, you can call us at <a href=tel:011-42015577>011-42015577</a>.",
            buttons: [
                {
                    text: 'Okay',
                    handler: () => {
    ...
    share()
    {
        ...
        let image = "";
        let app_url = "https://play.google.com/store/apps/details?id=com.rallisonwire.app";
        
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on Rallison Wire , a Electrician & Dealer app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "Reffral", image, app_url)
        .then(resp=>{
            console.log(resp);
